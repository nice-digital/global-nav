...
/*!
  ...
  http://jedwatson.github.io/classnames
*/
(function(){"use strict";var hasOwn={}.hasOwnProperty;function classNames(){var classes=[];for(var i=0;i<arguments.length;i++){var arg=arguments[i];if(!arg)continue;var argType=typeof arg;if(argType==="string"||argType==="number"){classes.push(arg)}else if(Array.isArray(arg)&&arg.length){var inner=classNames.apply(null,arg);if(inner){classes.push(inner)}}else if(argType==="object"){for(var key in arg){if(hasOwn.call(arg,key)&&arg[key]){classes.push(key)}}}}return classes.join(" ")}if(true&&module.exports){classNames["default"]=classNames;module.exports=classNames}else if(true){!(__WEBPACK_AMD_DEFINE_ARRAY__=[],__WEBPACK_AMD_DEFINE_RESULT__=function(){return classNames}.apply(exports,__WEBPACK_AMD_DEFINE_ARRAY__),__WEBPACK_AMD_DEFINE_RESULT__!==undefined&&(module.exports=__WEBPACK_AMD_DEFINE_RESULT__))}else{}})()},function(module,exports,__webpack_require__){"use strict";var _react=_interopRequireDefault(__webpack_require__(0));var _reactDom=__webpack_require__(8);var _Header=_interopRequireDefault(__webpack_require__(13));var _Footer=_interopRequireDefault(__webpack_require__(47));var _this=void 0;function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{"default":obj}}function _extends(){_extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key]}}}return target};return _extends.apply(this,arguments)}function _newArrowCheck(innerThis,boundThis){if(innerThis!==boundThis){throw new TypeError("Cannot instantiate an arrow function")}}var ensureCallback=function ensureCallback(callback){_newArrowCheck(this,_this);if(callback){callback=typeof callback==="function"?callback:window[callback];if(typeof callback==="function"){return callback}}return null}.bind(void 0);var config=window.global_nav_config||{};config.footer=config.footer||{};if(config.header!==false){config.header=config.header||{};var headerElement=document.getElementById("header");if(!headerElement){headerElement=document.createElement("div");document.body.insertBefore(headerElement,document.body.firstChild)}var onRendering=ensureCallback(config.header.onRendering);if(onRendering){onRendering.call(window,headerElement)}(0,_reactDom.render)(_react["default"].createElement(_Header["default"],_extends({service:config.service},config.header)),headerElement,function(){_newArrowCheck(this,_this);var onRendered=ensureCallback(config.header.onRendered);if(onRendered){onRendered.call(window,headerElement)}}.bind(void 0))}var footerElement=document.getElementById("footer");if(!footerElement){footerElement=document.createElement("div");document.body.appendChild(footerElement)}(0,_reactDom.render)(_react["default"].createElement(_Footer["default"],config.footer),footerElement)},function(module,exports,__webpack_require__){"use strict";
